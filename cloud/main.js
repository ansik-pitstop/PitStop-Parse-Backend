...
Parse.Cloud.define("carServicesUpdateLight", function(request, status){
  ...
  var foundCar = function (loadedCar) {
    ...
    var loadedEdmundsServices = function () {
      ...
      for (var i = 0; i < edmundsServices.length; i++) {
        ...
        serviceQuery.equalTo("action", edmundsServices.get("action"));
        serviceQuery.equalTo("item", edmundsServices.get("item"));
        serviceQuery.find({
          ...
          error: function (error) {
            ...
            console.error(
                ...
                {
                  action: edmundsServices.get("action"),
                  item: edmundsServices.get("item")
                });
            console.error("ERROR: ", error);
